...
class AppLocalizationsBs extends AppLocalizations {
  ...
  String get invoicePdfError =>
      'Nije uspjelo generisanje PDF-a. Faktura nije promijenjena — pokušajte ponovo.';

  @override
  String get invoiceQrEligibleBody =>
      'Ova faktura će sadržavati NBS IPS QR kod za plaćanje.';

  @override
  String get invoiceQrIneligibleBody =>
      'Dodajte broj računa i šifru plaćanja u Postavke → Poslovni profil kako biste uključili QR kod za plaćanje na ovoj fakturi.';
  ...
  String get toolsCrossBorderSubtitle =>
      'Uporedi istu bruto plaću u svih 9 zemalja';
  ...
  String crossBorderUnavailableNoRate(String currency) {
    return 'Nema sačuvanog kursa za $currency — konvertujte ga jednom na kartici Konverzija da omogućite ovaj red.';
  }
  ...
  String get crossBorderScopeNote =>
      'Ovo poređenje obuhvata samo bruto-u-neto plaću i trošak poslodavca. Dnevnice i kilometraža još nisu uključene — provjerene zvanične stope nisu dostupne za sve zemlje.';

  @override
  String get crossBorderDisclaimer =>
      'Unesite jednu bruto plaću u EUR. Svaka zemlja je konvertuje u svoju valutu koristeći posljednji sačuvani kurs, a zatim je obračunava po stvarnim pravilima te zemlje — brojevi se nikad ne poređuju bez konverzije valute. Godišnje vrijednosti su mjesečni obračun × 12. Ovo je procjena samo za poređenje, ne poreski savjet.';
  ...
  String get crossBorderInitialEmptyState =>
      'Unesite bruto plaću i dodirnite Izračunaj da uporedite svih 9 zemalja.';
  ...
  String get receiptScannerPermissionDeniedBody =>
      'Dozvolite pristup kameri da biste skenirali QR kod računa, ili ga unesite ručno ispod. Ako ste ranije odbili pristup, možda ćete morati omogućiti ga u sistemskim postavkama uređaja.';
  ...
  String get receiptScannerUnavailableBody =>
      'Kamera se nije mogla pokrenuti na ovom uređaju. I dalje možete ručno unijeti kod računa ispod.';
  ...
  String get receiptScannerManualEntryHint =>
      'Zalijepite ili unesite sadržaj QR koda';
  ...
  String receiptScannerResultRecognizedBody(String status) {
    return 'Ovo liči na QR kod srpskog fiskalnog računa prema lokalnom formatu (nije fiskalna provjera). Dodano je u vaš lokalni red kao „$status“.';
  }
  ...
  String get receiptScannerResultMalformedBody =>
      'Ovo podsjeća na kod srpskog fiskalnog računa, ali ne odgovara očekivanom formatu. Sačuvano je da biste ga mogli pregledati.';
  ...
  String get receiptScannerResultUnknownBody =>
      'Ovaj QR kod ne odgovara formatu fiskalnog računa nijedne podržane zemlje. Sačuvano je da biste ga mogli pregledati.';
  ...
  @override
  String get receiptScannerViewQueueTooltip => 'Pogledaj red čekanja';
  ...
  @override
  String get receiptHandoffTitle => 'Kreiraj trošak iz skeniranja';
