...
class AppLocalizationsHr extends AppLocalizations {
  ...
  String freelanceRsMinPioBaseBinds(String amount) {
    return 'Doprinos za mirovinsko (PIO) kod Modela B ograničen je na minimalnu osnovicu ($amount) — ovo je situacija koju ljudi najčešće krivo procijene.';
  }

  @override
  String get freelanceComparatorTitle => 'Usporedi Model A i Model B';
  ...
  String get freelanceComparatorNeedsIncome =>
      'Unesite prihod iznad kako biste usporedili oba modela.';
  ...
  String get settingsEntitlementFreeSubtitle =>
      'Otključajte svih 9 zemalja, neograničene usporedbe, fakturiranje i paket usklađenosti';

  @override
  String get settingsEntitlementTrialingTitle => 'Pro — probno razdoblje';

  @override
  String get settingsEntitlementTrialingSubtitle =>
      'Vaše 7-dnevno probno razdoblje je aktivno — upravljajte ili otkažite bilo kada u računu trgovine';
  ...
  String get settingsEntitlementPreviewDescription =>
      'Samo simulacija za testiranje — ne dolazi do stvarne kupnje ili naplate. Dostupno samo u razvojnim verzijama.';
  ...
  @override
  String get paywallHeadline => 'Otključajte kompletan alatni komplet';

  @override
  String get paywallPitch =>
      'Svaki kalkulator plaće, pretvarač valuta i osnovni financijski alat ostaje besplatan u svakom slučaju. Pro otključava specijalizirane razlike koje zahtijevaju najviše truda: svih 9 zemalja jedna pored druge, neograničene spremljene usporedbe, profesionalno fakturiranje i kompletan paket usklađenosti.';
  ...
  @override
  String get paywallFeaturesTitle => 'Što Pro otključava';
  ...
  String get paywallFeatureUnlimitedComparisons =>
      'Neograničene spremljene prekogranične usporedbe';

  @override
  String get paywallFeatureInvoicePdf =>
      'Profesionalne PDF fakture s QR kodovima za plaćanje';
  ...
  String paywallAnnualTrialNote(String price) {
    return '7-dnevno besplatno probno razdoblje, zatim ekvivalent od $price/mjesečno. Otkažite bilo kada.';
  }
  ...
  String get paywallSupportSubtitle =>
      'Jednokratna zahvala — ne mijenja vaš plan niti otključava bilo što dodatno';
  ...
  String get paywallProductComingSoon =>
      'Još nije dostupno u ovoj verziji — dolazi kada se aplikacija objavi u trgovini';
  ...
  @override
  String get invoiceGeneratingPdf => 'Generiranje PDF-a…';
  ...
  String get pausalTrackerStateWarning95 =>
      'Dosegnuto 95% — vjerojatno je uskoro potrebna akcija';
  ...
  String pausalTrackerExcludedBanner(int count) {
    return '$count račun(a) isključeno — tečaj nije dostupan';
  }
  ...
  String get pausalTrackerBreakdownExcludedHeader =>
      'Isključeno — tečaj nije dostupan';
  ...
  String get pausalTrackerBreakdownExcludedReason =>
      'Za ovaj račun nije bilo moguće dohvatiti tečaj — isključen je iz ukupnog iznosa umjesto da bude procijenjen.';
  ...
  @override
  String get pausalTrackerAssessedAmountSaved => 'Spremljeno';
  ...
  String pausalTrackerAssessedAmountDecomposition(
    ...
    return '= $tax porez + $pio mirovinsko + $health zdravstveno + $unemployment nezaposlenost = $total osnovice utvrđene rješenjem.';
  }
  ...
  String get toolsReceiptScannerSubtitle =>
      'Skenirajte QR kod računa i spremite ga lokalno, izvanmrežno';
  ...
  String get receiptScannerHint =>
      'Usmjerite kameru na QR kod fiskalnog računa';
  ...
  String get receiptScannerPermissionDeniedBody =>
      'Dopustite pristup kameri za skeniranje QR koda računa ili ga unesite ručno ispod. Ako ste ranije odbili pristup, možda ćete ga morati omogućiti u sistemskim postavkama uređaja.';

  @override
  String get receiptScannerUnavailableTitle => 'Kamera nedostupna';

  @override
  String get receiptScannerUnavailableBody =>
      'Kameru nije bilo moguće pokrenuti na ovom uređaju. I dalje možete ručno unijeti kod računa ispod.';
  ...
  String get receiptScannerManualEntryHint =>
      'Zalijepite ili upišite sadržaj QR koda';

  @override
  String get receiptScannerManualEntryEmptyError => 'Najprije unesite tekst';
  ...
  String receiptScannerResultRecognizedBody(String status) {
    return 'Ovo izgleda kao QR kod srpskog fiskalnog računa prema lokalnom formatu (nije fiskalna provjera). Dodano je u vaš lokalni popis kao „$status“.';
  }

  @override
  String get receiptScannerResultMalformedTitle =>
      'Ne izgleda kao valjan kod računa';

  @override
  String get receiptScannerResultMalformedBody =>
      'Ovo podsjeća na kod srpskog fiskalnog računa, ali ne odgovara očekivanom formatu. Spremljeno je kako biste ga mogli pregledati.';
  ...
  String get receiptScannerResultUnknownBody =>
      'Ovaj QR kod ne odgovara formatu fiskalnog računa nijedne podržane zemlje. Spremljeno je kako biste ga mogli pregledati.';
  ...
  @override
  String get gateCrossBorderSaveTitle => 'Spremite više usporedbi uz Pro';

  @override
  String get gateCrossBorderSaveBody =>
      'Besplatni plan čuva jednu spremljenu prekograničnu usporedbu odjednom. Nadogradite na Pro za neograničene spremljene usporedbe.';

  @override
  String get gateInvoicePdfTitle => 'Generirajte PDF fakture uz Pro';

  @override
  String get gateInvoicePdfBody =>
      'Profesionalne PDF fakture s QR kodovima za plaćanje su Pro značajka. Nadogradite da generirate ovu fakturu kao PDF.';
  ...
  String get gatePausalTrackerBody =>
      'Kompletan paket usklađenosti za paušal i PDV — praćenje prometa, mjesečni podsjetnici i usporedba Model A/Model B — je Pro značajka.';
