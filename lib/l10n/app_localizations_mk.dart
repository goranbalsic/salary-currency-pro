...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String notifPausalReminderNotifBodyWithAmount(String amount) {
    return 'Не заборавајте ја месечната пријава и уплата на паушалот во износ од $amount RSD.';
  }

  @override
  String get notifPausalLeadReminderTitle => 'Потсети ме и 3 дена порано';

  @override
  String get notifPausalLeadReminderSubtitle =>
      'Дополнителен потсетник на 12-ти, пред главниот на 15-ти';

  @override
  String get notifPausalLeadReminderNotifTitle => 'Пријава на паушал за 3 дена';

  @override
  String get notifPausalLeadReminderNotifBody =>
      'Месечната пријава и уплата на паушалот доспева за 3 дена, на 15-ти.';
  ...
  @override
  String get settingsBusinessProfileTitle => 'Деловен профил';

  @override
  String get settingsBusinessProfileExplainer =>
      'Се користи на генерираните PDF фактури и, за прифатливи фактури во RSD, на NBS IPS QR кодот за плаќање.';

  @override
  String get businessProfileNameLabel => 'Име на фирма / издавач';

  @override
  String get businessProfileAddressLabel => 'Адреса';

  @override
  String get businessProfileCityLabel => 'Град';

  @override
  String get businessProfileBankAccountLabel => 'Број на сметка (Србија)';

  @override
  String get businessProfileBankAccountHelper =>
      'Потребно само за NBS IPS QR кодот на RSD фактури';

  @override
  String get businessProfilePaymentCodeLabel =>
      'Стандардна шифра за плаќање (Србија)';

  @override
  String get businessProfilePaymentCodeHelper =>
      'Троцифрена NBS шифра за плаќање, на пр. 289 — потребна само за QR кодот';
  ...
  String get freelanceRsInsuredElsewhereLabel =>
      'Веќе сте осигурани по друга основа (придонесот за здравство не се плаќа)';

  @override
  String freelanceRsMinPioBaseBinds(String amount) {
    return 'Придонесот за ПИО кај Моделот Б е ограничен на минималната основица ($amount) — ова е случајот што луѓето најчесто го проценуваат погрешно.';
  }

  @override
  String get freelanceComparatorTitle => 'Спореди Модел А и Модел Б';

  @override
  String get freelanceComparatorQuarterLabel => 'Квартал';

  @override
  String freelanceComparatorDeadlineHint(String date) {
    return 'Рок за пријава за овој квартал: $date';
  }

  @override
  String get freelanceComparatorNeedsIncome =>
      'Внесете приход погоре за да ги споредите двата модела.';

  @override
  String freelanceComparatorRecommended(String model, String amount) {
    return 'Препорака: $model — заштеда од $amount во нето приход.';
  }

  @override
  String get settingsEntitlementFreeTitle => 'Бесплатно';

  @override
  String get settingsEntitlementFreeSubtitle =>
      'Отклучете ги сите 9 земји, неограничени споредби, фактурирање и пакетот за усогласеност';

  @override
  String get settingsEntitlementTrialingTitle => 'Pro — пробен период';

  @override
  String get settingsEntitlementTrialingSubtitle =>
      'Вашиот 7-дневен пробен период е активен — управувајте или откажете во секое време во сметката на продавницата';

  @override
  String get settingsEntitlementProTitle => 'Pro — активно';

  @override
  String get settingsEntitlementProSubtitle =>
      'Ви благодариме што ја поддржувате апликацијата';

  @override
  String get settingsEntitlementLifetimeTitle => 'Pro — доживотно';

  @override
  String get settingsEntitlementLifetimeSubtitle =>
      'Имате постојан пристап — ви благодариме';

  @override
  String get settingsEntitlementExpiredTitle => 'Pro — истечено';
  ...
  @override
  String get paywallHeadline => 'Отклучете го целосниот сет алатки';

  @override
  String get paywallPitch =>
      'Секој калкулатор за плата, конвертор на валута и основна финансиска алатка останува бесплатна во секој случај. Pro ги отклучува специјализираните разлики со најмногу вложен труд: сите 9 земји една до друга, неограничени зачувани споредби, професионално фактурирање и целосниот пакет за усогласеност.';
  ...
  @override
  String get paywallFeaturesTitle => 'Што отклучува Pro';

  @override
  String get paywallFeatureAllCountries =>
      'Целосните калкулатори на сите 9 земји, не само вашата матична земја';

  @override
  String get paywallFeatureUnlimitedComparisons =>
      'Неограничени зачувани прекугранични споредби';

  @override
  String get paywallFeatureInvoicePdf =>
      'Професионални PDF фактури со QR кодови за плаќање';

  @override
  String get paywallFeatureCompliancePack =>
      'Целосниот пакет за усогласеност со паушал и ДДВ';

  @override
  String get paywallSectionAnnualTitle => 'Годишен';

  @override
  String get paywallAnnualBadge => 'Најдобра вредност';

  @override
  String paywallAnnualTrialNote(String price) {
    return '7-дневен бесплатен пробен период, потоа еквивалент од $price/месечно. Откажете во секое време.';
  }

  @override
  String get paywallSectionMonthlyTitle => 'Месечен';

  @override
  String get paywallLifetimeTitle => 'Доживотен';

  @override
  String get paywallLifetimeSubtitle => 'Платете еднаш, поседувајте засекогаш';

  @override
  String get paywallSupportTitle => 'Поддржете го развивачот';

  @override
  String get paywallSupportSubtitle =>
      'Еднократна благодарност — не го менува вашиот план ниту отклучува нешто дополнително';

  @override
  String paywallPricePerYear(String price) {
    return '$price/годишно';
  }

  @override
  String paywallPricePerMonth(String price) {
    return '$price/месечно';
  }

  @override
  String paywallPriceOneTime(String price) {
    return '$price еднократно';
  }

  @override
  String get paywallBuySubscription => 'Претплати се';

  @override
  String get paywallBuyLifetime => 'Купи доживотен';

  @override
  String get paywallBuySupport => 'Испрати поддршка';

  @override
  String get paywallProductComingSoon =>
      'Сè уште не е достапно во оваа верзија — доаѓа кога апликацијата ќе се објави во продавницата';
  ...
  @override
  String get invoiceGeneratingPdf => 'Генерирање на PDF…';
  ...
  String get toolsPausalTrackerSubtitle =>
      'Следете го прометот во однос на паушалниот цензус и прагот за ДДВ';

  @override
  String get pausalTrackerCeilingCardTitle =>
      'Паушален цензус (оваа календарска година)';

  @override
  String get pausalTrackerVatCardTitle => 'Праг за ДДВ (последните 12 месеци)';

  @override
  String get pausalTrackerStateOk => 'Во ред е';

  @override
  String get pausalTrackerStateWarning70 =>
      'Достигнати 70% — вреди да се следи';

  @override
  String get pausalTrackerStateWarning85 =>
      'Достигнати 85% — обрнете посебно внимание';

  @override
  String get pausalTrackerStateWarning95 =>
      'Достигнати 95% — веројатно наскоро е потребна акција';

  @override
  String get pausalTrackerStateExceeded => 'Надминато';

  @override
  String pausalTrackerProjection(String date) {
    return 'По моменталното темпо, паушалниот цензус би го достигнале околу $date.';
  }

  @override
  String pausalTrackerExcludedBanner(int count) {
    return '$count фактура(и) исклучени — курсот не е достапен';
  }

  @override
  String get pausalTrackerSeeBreakdown => 'Погледнете ги бројките';

  @override
  String get pausalTrackerBreakdownTitle => 'Како е ова пресметано';

  @override
  String get pausalTrackerBreakdownExcludedHeader =>
      'Исклучено — курсот не е достапен';
  ...
  String get pausalTrackerBreakdownExcludedReason =>
      'За оваа фактура не можеше да се преземе курс — исклучена е од вкупниот износ наместо да биде проценета.';

  @override
  String get pausalTrackerAssessedAmountLabel =>
      'Утврден месечен износ на паушал';

  @override
  String get pausalTrackerAssessedAmountHint =>
      'Опционално — внесете го износот од вашето даночно решение. Апликацијата не може сама да го пресмета.';

  @override
  String get pausalTrackerAssessedAmountSaved => 'Зачувано';
  ...
  String pausalTrackerAssessedAmountDecomposition(
    ...
    return '= $tax данок + $pio ПИО + $health здравство + $unemployment невработеност = $total од основицата утврдена со решението.';
  }
  ...
  @override
  String get gateCountrySwitchTitle => 'Менувајте земји со Pro';

  @override
  String get gateCountrySwitchBody =>
      'Бесплатниот план го покрива целосниот калкулатор само на вашата тековна земја. Надградете на Pro за да ги отклучите сите 9 земји.';

  @override
  String get gateCrossBorderSaveTitle => 'Зачувајте повеќе споредби со Pro';

  @override
  String get gateCrossBorderSaveBody =>
      'Бесплатниот план чува една зачувана прекугранична споредба во исто време. Надградете на Pro за неограничени зачувани споредби.';

  @override
  String get gateInvoicePdfTitle => 'Генерирајте PDF фактури со Pro';

  @override
  String get gateInvoicePdfBody =>
      'Професионалните PDF фактури со QR кодови за плаќање се Pro функција. Надградете за да ја генерирате оваа фактура како PDF.';

  @override
  String get gatePausalTrackerTitle =>
      'Отклучете го пакетот за усогласеност со Pro';

  @override
  String get gatePausalTrackerBody =>
      'Целосниот пакет за усогласеност со паушал и ДДВ — следење на промет, месечни потсетници и споредбата Модел A/Модел Б — е Pro функција.';
