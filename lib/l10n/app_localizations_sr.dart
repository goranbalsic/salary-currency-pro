...
class AppLocalizationsSr extends AppLocalizations {
  ...
  String get settingsWidgetsExplainer =>
      'Dodajte vidžet sa početnog ekrana uređaja (dugo pritisnite prazan prostor → Vidžeti → Salary & Currency Pro) — aplikacija ne može sama da ga doda. Nakon dodavanja se sam ažurira.';

  @override
  String get settingsWidgetsPinnedPairTitle => 'Zakačeni valutni par za vidžet';

  @override
  String get homeWidgetBudgetLabel => 'Potrošeno ovog meseca';

  @override
  String get homeWidgetBudgetEmpty =>
      'Podesite budžet u aplikaciji da ga vidite ovde';

  @override
  String get homeWidgetPairUnavailable =>
      'Osvežavanje nije uspelo — prikazan je poslednji poznati kurs';
  ...
  String get businessProfilePaymentCodeLabel =>
      'Podrazumevana šifra plaćanja (Srbija)';
  ...
  String get paywallPitch =>
      'Svaki kalkulator plate, konverter valute i osnovni finansijski alat ostaje besplatan u svakom slučaju. Pro otključava specijalizovane razlike koje zahtevaju najviše truda: svih 9 zemalja jedna pored druge, neograničena sačuvana poređenja, profesionalno fakturisanje i kompletan paket usklađenosti.';
  ...
  @override
  String get paywallAnnualBadge => 'Najbolja vrednost';

  @override
  String paywallAnnualTrialNote(String price) {
    return '7-dnevni besplatni probni period, zatim ekvivalent od $price/mesečno. Otkažite bilo kada.';
  }

  @override
  String get paywallSectionMonthlyTitle => 'Mesečni';

  @override
  String get paywallLifetimeTitle => 'Doživotni';

  @override
  String get paywallLifetimeSubtitle => 'Platite jednom, posedujte zauvek';
  ...
  String get paywallSupportSubtitle =>
      'Jednokratno hvala — ne menja vaš plan niti otključava bilo šta dodatno';
  ...
  @override
  String get invoiceNumberLabel => 'Broj fakture (opciono)';
  ...
  @override
  String get invoiceItemUnitPrice => 'Jed. cena';
  ...
  String get invoiceAmountFromItemsHelper =>
      'Izračunato na osnovu stavki ispod';

  @override
  String get invoiceRemoveItemTooltip => 'Ukloni stavku';

  @override
  String get invoiceGeneratePdf => 'Generiši PDF';

  @override
  String get invoiceGeneratingPdf => 'Generisanje PDF-a…';
  ...
  @override
  String get toolsCrossBorderTitle => 'Prekogranično poređenje';

  @override
  String get toolsCrossBorderSubtitle =>
      'Uporedi istu bruto zaradu u svih 9 zemalja';

  @override
  String get crossBorderGrossLabel => 'Bruto zarada (EUR)';
  ...
  @override
  String get crossBorderColumnDeductions => 'Odbici zaposlenog';
  ...
  String crossBorderUnavailableNoRate(String currency) {
    return 'Nema sačuvanog kursa za $currency — konvertujte ga jednom na kartici Konverzija da biste omogućili ovaj red.';
  }

  @override
  String get crossBorderUnavailableConfig =>
      'Poreski podaci nisu dostupni za ovu zemlju.';

  @override
  String get crossBorderScopeNote =>
      'Ovo poređenje obuhvata samo bruto-u-neto zaradu i trošak poslodavca. Dnevnice i kilometraža još nisu uključene — proverene zvanične stope nisu dostupne za sve zemlje.';

  @override
  String get crossBorderDisclaimer =>
      'Unesite jednu bruto zaradu u EUR. Svaka zemlja je konvertuje u svoju valutu koristeći poslednji sačuvani kurs, a zatim je obračunava po stvarnim pravilima te zemlje — nikada se brojevi ne porede bez konverzije valute. Godišnje vrednosti su mesečni obračun × 12. Ovo je procena samo za poređenje, ne poreski savet.';

  @override
  String crossBorderRateSourceLabel(String source, String date) {
    return '$source, sačuvano $date';
  }
  ...
  String get crossBorderInitialEmptyState =>
      'Unesite bruto zaradu i dodirnite Izračunaj da uporedite svih 9 zemalja.';

  @override
  String get crossBorderTapForDetail => 'Dodirnite red za potpuni obračun';

  @override
  String get toolsReceiptScannerTitle => 'Skener fiskalnih računa';

  @override
  String get toolsReceiptScannerSubtitle =>
      'Skenirajte QR kod računa i sačuvajte ga lokalno, van mreže';

  @override
  String get receiptScannerScreenTitle => 'Skener fiskalnih računa';

  @override
  String get receiptScannerStarting => 'Pokretanje kamere…';

  @override
  String get receiptScannerHint => 'Usmerite kameru na QR kod fiskalnog računa';
  ...
  String get receiptScannerPermissionDeniedBody =>
      'Dozvolite pristup kameri da biste skenirali QR kod računa, ili ga unesite ručno ispod. Ako ste ranije odbili pristup, možda ćete morati da ga omogućite u sistemskim podešavanjima uređaja.';

  @override
  String get receiptScannerUnavailableTitle => 'Kamera nije dostupna';

  @override
  String get receiptScannerUnavailableBody =>
      'Kamera nije mogla da se pokrene na ovom uređaju. I dalje možete ručno uneti kod računa ispod.';

  @override
  String get receiptScannerManualEntryButton => 'Unesi ručno';

  @override
  String get receiptScannerManualEntryTitle => 'Ručni unos koda računa';

  @override
  String get receiptScannerManualEntryHint =>
      'Nalepite ili unesite sadržaj QR koda';

  @override
  String get receiptScannerManualEntryEmptyError => 'Prvo unesite tekst';

  @override
  String get receiptScannerManualEntrySubmit => 'Dodaj u red';

  @override
  String get receiptScanStatusAwaitingFetch => 'Skenirano, čeka preuzimanje';

  @override
  String get receiptScannerResultRecognizedTitle =>
      'Prepoznat srpski fiskalni račun';

  @override
  String receiptScannerResultRecognizedBody(String status) {
    return 'Ovo liči na QR kod srpskog fiskalnog računa po lokalnom formatu (nije fiskalna provera). Dodato je u vaš lokalni red kao „$status“.';
  }

  @override
  String get receiptScannerResultMalformedTitle =>
      'Ne liči na validan kod računa';

  @override
  String get receiptScannerResultMalformedBody =>
      'Ovo podseća na kod srpskog fiskalnog računa, ali ne odgovara očekivanom formatu. Sačuvano je da biste mogli da ga pregledate.';

  @override
  String get receiptScannerResultUnknownTitle =>
      'Nije prepoznat fiskalni račun';

  @override
  String get receiptScannerResultUnknownBody =>
      'Ovaj QR kod ne odgovara formatu fiskalnog računa nijedne podržane zemlje. Sačuvano je da biste mogli da ga pregledate.';

  @override
  String get receiptScannerResultScanAnother => 'Skeniraj još jedan';
  ...
  String get receiptQueueEmptyState =>
      'Još nema skeniranih računa. Skenirajte QR kod fiskalnog računa da ga dodate ovde.';

  @override
  String get receiptQueueStatusLinked => 'Povezano sa troškom';
  ...
  @override
  String get receiptQueueDeleteConfirmTitle => 'Obrisati ovo skeniranje?';

  @override
  String get receiptQueueDeleteConfirmBody =>
      'Ovo uklanja skenirani račun iz vašeg lokalnog reda.';

  @override
  String get receiptQueueDeletedConfirmation => 'Skeniranje je obrisano';

  @override
  String get receiptHandoffTitle => 'Napravi trošak iz skeniranja';
  ...
  @override
  String get gateCountrySwitchTitle => 'Menjajte zemlje uz Pro';
  ...
  String get gatePausalTrackerBody =>
      'Kompletan paket usklađenosti za paušal i PDV — praćenje prometa, mesečni podsetnici i poređenje Model A/Model B — je Pro funkcija.';
