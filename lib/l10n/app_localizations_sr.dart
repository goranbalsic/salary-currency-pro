...
class AppLocalizationsSr extends AppLocalizations {
  ...
  String get samoInfoBanner =>
      'Za frilensere koji primaju strani prihod direktno i prijavljuju ga kvartalno putem obrasca PP OPO-K (samooporezivanje) — ne za registrovane paušalne preduzetnike (\"paušalac\"), čiji iznos poreza utvrđuje Poreska uprava, a ne formula. Ovo prikazuje samo porez na dohodak od 10%; doprinosi za socijalno osiguranje za ovaj režim još nisu uključeni — proverite ih posebno.';
