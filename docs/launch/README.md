...
| File | What it is |
|---|---|
| [PLAY_CONSOLE.md](PLAY_CONSOLE.md) | Step-by-step Play Console setup: signing, app content answers, data safety, products and prices, testing tracks, device checklist |
| [GROWTH.md](GROWTH.md) | Who pays and why, prices, the arithmetic to 500 €/month, launch plan, ASO, metrics, what to build next |
| [store_listing/](store_listing/) | Title, short and full description in English, Serbian, Croatian, Bosnian, Slovenian, Macedonian, Bulgarian and Romanian |
| [assets/play_icon_512.png](assets/play_icon_512.png) | Store icon, 512 × 512 |
